...
export const QuestionSixScreen = ({navigation}) => {
                ...
                <TouchableWithoutFeedback onPress={Keyboard.dismiss}>
                    <Box h={"100%"} px={20} py={14} flexDirection="column" justifyContent="space-between">
                        ...
                        <HStack alignSelf="center" py={horizontalScale(50)} px={verticalScale(50)}>
                            ...
                            <Box m={verticalScale(8)} width={horizontalScale(150)}>
                                <Button bgColor="rgba(255, 185, 198, 0.5)" alignContent="center" borderRadius="$full" height={verticalScale(60)} onPress={() => {navigation.navigate("QuestionSevenScreen"); }}>
                                    <Text textAlign="center" w={"100%"} >
